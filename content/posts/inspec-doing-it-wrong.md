...
I've been using [InSpec](https://www.inspec.io/) for over 2 years now and have been writing automated tests for longer than that. What's the one thing that I've seen trip up the most people? Useless tests.
